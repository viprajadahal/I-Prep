...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000", "http://localhost:8000"],  # restrict in production
...
from app.routers import auth, writing, speaking, listening, reading, analytics, study_resources, admin
